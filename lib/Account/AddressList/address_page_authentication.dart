// @dart=2.9
import 'package:aqua/Account/AddressList/address_list.dart';
...
class AddressAuthentication extends StatelessWidget {
  const AddressAuthentication({Key key}) : super(key: key);
      ...
      child: BlocBuilder<AuthenticationBloc, AuthenticationState>(
        builder: (context, state) {
          ...
          if (state is Authenticated) {
            ...
            return AddressList(userData: state.userData);
          } else {
            return Scaffold();
          }
        },
